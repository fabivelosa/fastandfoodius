...
<title>Fast and Foodius - Login</title>
			...
			<div class=" " id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<% if (session.getAttribute("logged") == Boolean.TRUE) { %>
				     <li class="nav-item"><a class="nav-link js-scroll-trigger"  id="#logout" href="${pageContext.request.contextPath}/pages/LogOut " target="" >Logout</a></li>
					<% } else {%>
